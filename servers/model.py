...
teacher_correct_answer = pytesseract.image_to_string(teacher_image)

# Define a list of student responses (assuming they are stored in text files)
student_responses = []
...
for student_id, response in enumerate(student_responses, start=1):
    ...
    feedback, score = generate_feedback_and_score(sentiment, grammar, complexity, custom, similarity)
